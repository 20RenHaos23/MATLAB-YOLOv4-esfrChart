...
img = imread('test_chart_2017_Standard.png');
...
for i = 1:numRows
    for j = 1:numCols
        ...
        if ~isempty(edge_sub) || ~isempty(gray_sub) || ~isempty(color_sub)
            ...
            filename = sprintf('%s\\test_chart_2017_Standard\\subImg_%d_%d.jpg', currentFolder, i, j);
...
matFilename = fullfile(currentFolder, 'test_chart_2017_Standard.mat');
save(matFilename, 'T');
